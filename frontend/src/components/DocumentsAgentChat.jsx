          ...
          <div className="flex-1 overflow-y-auto px-md py-sm space-y-xs">
            ...
            {history.map((conv) => (
              <button
                ...
                className="w-full flex items-center justify-between gap-xs px-sm py-sm rounded-lg border border-outline-variant/60 bg-surface-container/40 hover:bg-surface-container transition-colors text-right"
              >
